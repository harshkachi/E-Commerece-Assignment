...
import com.myself.service.ProductImpl;
...
public class CustomerController {
	...
	public ResponseEntity<List<Product>> searchByName(@PathVariable("productName") String name){
		
		List<Product> list = pi.getListProduct(name);
	...
	public ResponseEntity<List<Product>> searchByType(@PathVariable("productType") String type){
			
		List<Product> list = pi.getListProductType(type);
	...
	public ResponseEntity<List<Product>> searchByCategory(@PathVariable("productCategory") String category){
				
		List<Product> list = pi.getListProductCategory(category);
